...
**QIAN**：同“乾”，在《易经》当中，乾卦代表天，代表宇宙万物运转的规律，是最崇高的正向能量和精神，遵循这两个重要的涵义，我们将比特币生态当中首个去中心化稳定币命名为 QIAN。 QIAN 由原力协议团队所开发，是原力金融生态的重要成员，在比特币 RSK 侧链和以太坊网络内流通，可以被创造（`mint`）也可以被销毁（`burn`），用于借贷、投资、支付、储值等应用场景。
